...
class FenixWebview {
    ...
    createWebviewPanel() {
        return vscode.window.createWebviewPanel('fenix', 'Fenix', vscode.ViewColumn.One, {
            enableScripts: true,
        });
    }
    show() {
        ...
        if (!fs_1.existsSync(webviewPath)) {
    ...
    `;
        this._webviewPanel.webview.onDidReceiveMessage((message) => {
            Fenix_1.default.get().handleWebviewEvent(message);
        }, undefined, this._context.subscriptions);
        this._webviewPanel.onDidDispose(() => this._webviewPanel = undefined);
        this._webviewPanel.reveal();
    }
}
exports.default = FenixWebview;
//# sourceMappingURL=FenixWebview.js.map