...
- changing the 'show last tasks' or 'show favorites' settings have no effect until restart [Fixes [#173](https://github.com/spmeesseman/vscode-taskexplorer/issues/173)]
...
- add new setting 'show hidden vscode tasks', which will not include workspace tasks in the task tree that have with the 'hide' property set in the task definition.  Defaults to 'true' to resume past behavior. [Closes [#182](https://github.com/spmeesseman/vscode-taskexplorer/issues/182)]
...
- ant tasks no longer show relative path in grouped tree nodes if file is named build.xml. [Fixes [#179](https://github.com/spmeesseman/vscode-taskexplorer/issues/179)]

### Features

- add new setting 'expanded', an object that can specify either special or project folders to either be expanded or collapsed in the explorer tree on startup. [Closes [#176](https://github.com/spmeesseman/vscode-taskexplorer/issues/176)]
...
- add new setting 'excludeTask', an array of regex pattern strings that can be used to ignore / exclude specific task names globally.   Available in the context menus as well as editing the VSCode settings manually. [Closes [#178](https://github.com/spmeesseman/vscode-taskexplorer/issues/178)]
