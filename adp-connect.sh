...
DEFAULT_RANCHER_HOSTNAME="rancher.dev.mosgarage.xyz"
DEFAULT_RANCHER_AUTH_PROVIDER="azureADProvider"
DEFAULT_ARTIFACTORY_HOSTNAME="artifactory.dev.mosgarage.xyz"
DEFAULT_ARGOCD_HOSTNAME="argo.kube.dev.mosgarage.xyz"
DEFAULT_GITHUB_SERVERS=("dev.mosgarage.xyz/github" "github.com")
...
get_artifactory_token() {
    info "🐳 It's time to login to Artifactory Go to https://artifatory.oit.dev.mosgarage.xyz
